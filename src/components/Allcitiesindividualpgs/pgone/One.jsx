  ...
  return (
    ...
    <div className='container-flued  p-0'>
      <div className="row h-100 p-0">
        ...
        <div className="col-12 col-lg-3 overflow-hidden p-0 h-full"><img className='h-full w-full object-cover ' src="/src\components\Allcitiesindividualpgs\pgone\deom1.jpg" alt="" /></div>
          <div className="col-12 col-lg-3 overflow-hidden p-0 h-full"><img className='h-full w-full object-cover ' src="/src\components\Allcitiesindividualpgs\pgone\demo2.jpg" alt="" /></div>
          <div className="col-12 col-lg-3 overflow-hidden p-0 h-full"><img className='h-full w-full object-cover ' src="/src\components\Allcitiesindividualpgs\pgone\demo3.jpg" alt="" /></div>
          <div className="col-12 col-lg-3 overflow-hidden p-0 h-full"><img className='h-full w-full object-cover ' src="/src\components\Allcitiesindividualpgs\pgone\demo4.jpg" alt="" /></div>
        </div>
