  ...
  return (
    ...
    <div className='container-flued  p-0'>
      <div className="row h-100 p-0">
        ...
        <div className="col-12 col-lg-3 overflow-hidden p-0 h-full"><img className='h-full w-full object-cover ' src="/src\components\Allcitiesindividualpgs\otowhitehousesec104\IMG-20230816-WA0012.jpg" alt="" /></div>
          <div className="col-12 col-lg-3 overflow-hidden p-0 h-full"><img className='h-full w-full object-cover ' src="/src\components\Allcitiesindividualpgs\otowhitehousesec104\IMG-20230816-WA0013.jpg" alt="" /></div>
          <div className="col-12 col-lg-3 overflow-hidden p-0 h-full"><img className='h-full w-full object-cover ' src="/src\components\Allcitiesindividualpgs\otowhitehousesec104\IMG-20230816-WA0015.jpg" alt="" /></div>
          <div className="col-12 col-lg-3 overflow-hidden p-0 h-full"><img className='h-full w-full object-cover ' src="/src\components\Allcitiesindividualpgs\otowhitehousesec104\IMG-20230816-WA0017.jpg" alt="" /></div>
        </div>
