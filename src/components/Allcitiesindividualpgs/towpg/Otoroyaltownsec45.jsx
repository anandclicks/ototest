  ...
  return (
    ...
    <div className='container-flued  p-0'>
      <div className="row h-100 p-0">
        ...
        <div className="col-12 col-lg-3 overflow-hidden p-0 h-full"><img className='h-full w-full object-cover ' src="/src\components\Allcitiesindividualpgs\otoroyaltownsec45\IMG-20230523-WA0000.jpg" alt="" /></div>
          <div className="col-12 col-lg-3 overflow-hidden p-0 h-full"><img className='h-full w-full object-cover ' src="/src\components\Allcitiesindividualpgs\otoroyaltownsec45\IMG-20230523-WA0001.jpg" alt="" /></div>
          <div className="col-12 col-lg-3 overflow-hidden p-0 h-full"><img className='h-full w-full object-cover ' src="/src\components\Allcitiesindividualpgs\otoroyaltownsec45\IMG-20230523-WA0003.jpg" alt="" /></div>
          <div className="col-12 col-lg-3 overflow-hidden p-0 h-full"><img className='h-full w-full object-cover ' src="/src\components\Allcitiesindividualpgs\otoroyaltownsec45\IMG-20230523-WA0004.jpg" alt="" /></div>
        </div>
