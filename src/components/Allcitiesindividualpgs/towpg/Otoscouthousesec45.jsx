  ...
  return (
    ...
    <div className='container-flued  p-0'>
      <div className="row h-100 p-0">
        ...
        <div className="col-12 col-lg-3 overflow-hidden p-0 h-full"><img className='h-full w-full object-cover ' src="/src\components\Allcitiesindividualpgs\otoscouthousesec45\IMG-20230905-WA0033.jpg" alt="" /></div>
          <div className="col-12 col-lg-3 overflow-hidden p-0 h-full"><img className='h-full w-full object-cover ' src="/src\components\Allcitiesindividualpgs\otoscouthousesec45\IMG-20230905-WA0035.jpg" alt="" /></div>
          <div className="col-12 col-lg-3 overflow-hidden p-0 h-full"><img className='h-full w-full object-cover ' src="/src\components\Allcitiesindividualpgs\otoscouthousesec45\IMG-20230905-WA0038.jpg" alt="" /></div>
          <div className="col-12 col-lg-3 overflow-hidden p-0 h-full"><img className='h-full w-full object-cover ' src="/src\components\Allcitiesindividualpgs\otoscouthousesec45\IMG-20230905-WA0041.jpg" alt="" /></div>
        </div>
        <div className="col-12 row row2 py-3 ">
          <div className="col-12 col-lg-8 ps-4 ps-lg-0 ">
            <h2 className='fwnormal fs-1 mt-3'>
            Oto scout house sec45
            </h2>
...
export default Otoscouthousesec45