...
function GaziyabadALlpg() {
  ...
  return (
      ...
      <img className="col-12 col-lg-6 thumbnail w-full object-cover" src="/src\components\Allcitiesindividualpgs\pgone\demo4.jpg" alt="Hotel Image" />
